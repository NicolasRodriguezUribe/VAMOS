...
class _ResultSummaryMixin(_ResultState):
...
class _ResultFrontMixin(_ResultSummaryMixin):
    @overload
...
class _ResultVisualizationMixin(_ResultFrontMixin):
...
class _ResultExportMixin(_ResultSummaryMixin):
