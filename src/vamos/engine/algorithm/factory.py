...
def build_algorithm(
    ...
    *,
    ...
    builders: dict[str, Callable[[], tuple[object, AlgorithmConfigProtocol]]] = {
        ...
        "gces": lambda: build_gces_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "gces_nocomp": lambda: build_gces_nocomp_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "gces_nogeo": lambda: build_gces_nogeo_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_farthest": lambda: build_nsga2_farthest_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_gapfill": lambda: build_nsga2_gapfill_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_curvgap": lambda: build_nsga2_curvgap_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_hvfarthest": lambda: build_nsga2_hvfarthest_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_refcover_farthest": lambda: build_nsga2_refcover_farthest_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_hvref_farthest": lambda: build_nsga2_hvref_farthest_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
        ...
        "nsga2_sector_farthest": lambda: build_nsga2_sector_farthest_algorithm(
            kernel=kernel,
            problem=problem,
            pop_size=pop_size,
            offspring_size=offspring_size,
