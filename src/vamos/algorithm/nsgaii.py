...
- Setup logic: nsgaii_setup.py
- State and results: nsgaii_state.py
- Helper functions: nsgaii_helpers.py
"""
...
from vamos.algorithm.nsgaii_setup import (
    parse_termination,
    setup_population,
    setup_archive,
    setup_genealogy,
...
from vamos.algorithm.nsgaii_state import (
    NSGAIIState,
    build_result,
    finalize_genealogy,
