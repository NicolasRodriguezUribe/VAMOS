...
from vamos.algorithm.archive import CrowdingDistanceArchive, HypervolumeArchive
from vamos.algorithm.variation import VariationPipeline
...
def finalize_genealogy(
    ...
    from vamos.algorithm.nsgaii_helpers import operator_success_stats, generation_contributions
