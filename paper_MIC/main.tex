...
A three-way comparison (fixed operator vs.\ random arm vs.\ AOS) with \AOSNSeeds{} seeds reveals two main findings: (i)~AOS converges \AOSConvergenceAdvPct{}\% faster than the fixed baseline at 10\% of the evaluation budget, and (ii)~AOS achieves a higher mean normalized HV (\AOSHVMeanAOS{} vs.\ \AOSHVMeanBaseline{}) with \AOSWins{}/\AOSNProblems{} problem wins at the final budget.
