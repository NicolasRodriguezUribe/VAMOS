...
We implement a generation-level AOS layer for NSGA-II in a vectorized optimization framework and evaluate it on real-world engineering surrogates from the RE and RWA benchmark suites.
...
\begin{itemize}
  ...
  \item An empirical evaluation on \AOSNProblems{} real-world engineering surrogates from the Tanabe--Ishibuchi RE~\cite{tanabe2020re} and Zapotecas-Mart\'{i}nez RWA~\cite{zapotecas2023rwa} benchmark suites, spanning 2--9 objectives, showing that AOS can improve median normalized hypervolume while incurring measurable runtime overhead.
\end{itemize}
