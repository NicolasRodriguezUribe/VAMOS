...
\begin{itemize}
  ...
  \item An empirical evaluation on \AOSNProblems{} standard MO benchmarks (ZDT, DTLZ, WFG) demonstrating that AOS achieves \AOSConvergenceAdvPct{}\% faster convergence at 20\% of budget, with \AOSWins{}/\AOSNProblems{} final-quality wins, while incurring measurable runtime overhead.
\end{itemize}
