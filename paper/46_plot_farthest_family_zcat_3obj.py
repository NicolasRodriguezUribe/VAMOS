"""Generate diagnostic figures for the farthest-family 3D ZCAT campaign."""
...
def _plot_pairwise_delta_heatmaps(
    ...
    figure, axes = plt.subplots(1, 2, figsize=(max(18, len(comparisons) * 1.35), 10), constrained_layout=True)
...
def _plot_hv_boxplots(
    ...
    figure, axes = plt.subplots(5, 4, figsize=(19, 14), sharey=False, constrained_layout=True)
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate diagnostic figures for the farthest-family 3-objective ZCAT campaign."
    )
