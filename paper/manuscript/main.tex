...
\item Competitive normalized hypervolume under a fixed-reference-front protocol with corrected statistics.
...
\begin{enumerate}
  ...
  \item \textbf{Comprehensive empirical comparison}: backend-level and cross-framework runtime comparisons, paired with statistical analysis of normalized hypervolume under a fixed protocol.
\end{enumerate}
...
Budget & Fixed number of objective evaluations (same across frameworks). \\
