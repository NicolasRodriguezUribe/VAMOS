...
\begin{tabular}{lcccc}
\toprule
\textbf{Feature} & \textbf{pymoo} & \textbf{jMetalPy} & \textbf{pygmo} & \textbf{VAMOS} \\
\midrule
Dominance-based algorithms          & \cmark & \cmark & \pmark & \cmark \\
Decomposition-based algorithms      & \cmark & \pmark & \pmark & \cmark \\
Indicator-based algorithms          & \pmark & \pmark & \xmark & \cmark \\
Pluggable computation backends      & \xmark & \xmark & \xmark & \cmark \\
Dense array population model        & \pmark & \xmark & \xmark & \cmark \\
Interchangeable variation operators & \pmark & \pmark & \xmark & \cmark \\
Configurable steady-state mode      & \xmark & \pmark & \xmark & \cmark \\
External archive support            & \xmark & \xmark & \xmark & \cmark \\
Performance indicators              & \cmark & \pmark & \xmark & \cmark \\
Parallelism                         & \pmark & \pmark & \cmark & \pmark \\
\textcolor{red}{Graphical user interface}            & \textcolor{red}{\xmark} & \textcolor{red}{\xmark} & \textcolor{red}{\xmark} & \textcolor{red}{\cmark} \\
Automatic algorithm selection       & \xmark & \xmark & \xmark & \cmark \\
\textcolor{red}{Min.\ lines of code\textsuperscript{$\dagger$}} & \textcolor{red}{$\sim$10} & \textcolor{red}{$\sim$15} & \textcolor{red}{--} & \textcolor{red}{2} \\
Active maintenance                  & \cmark & \pmark & \cmark & \cmark \\
\bottomrule
\multicolumn{5}{l}{\textcolor{red}{\footnotesize\textsuperscript{$\dagger$}Lines of code for a minimal NSGA-II run on a built-in benchmark.}}
\end{tabular}
\end{table*}
...
\midrule
VAMOS & \textbf{0.991 (0.013)} & \textbf{0.836 (0.121)} & \textbf{0.934 (0.138)} & \textbf{0.934 (0.157)} \\
pymoo & \textbf{0.991 (0.011)} & 0.829 (0.127) & 0.846 (0.220) & 0.918 (0.156) \\
jMetalPy & \textbf{0.991 (0.014)} & 0.834 (0.124) & 0.843 (0.218) & 0.922 (0.158) \\
\bottomrule
\end{tabular}
\end{table}
