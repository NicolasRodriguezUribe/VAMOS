...
Mutation & \texttt{non\_uniform(perturbation=0.5, prob=0.1, prob\_factor=1.034)} \\
...
\midrule
Baseline & 1.40 & 1.43 & \textbf{1.62} & 1.48 \\
Baseline + AOS & \textbf{1.33} & \textbf{1.43} & 1.65 & \textbf{1.47} \\
Racing-tuned & 5.67 & 5.69 & 3.88 & 5.08 \\
Racing-tuned + AOS & 9.25 & 10.35 & 4.15 & 7.91 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Variant} & \textbf{ZDT} & \textbf{DTLZ} & \textbf{WFG} & \textbf{Average} \\
\midrule
Baseline & 0.990 & 0.802 & \textbf{0.937} & 0.910 \\
Baseline + AOS & 0.990 & 0.822 & 0.936 & 0.916 \\
Racing-tuned & \textbf{0.994} & \textbf{0.932} & 0.873 & \textbf{0.933} \\
Racing-tuned + AOS & 0.993 & 0.914 & 0.889 & 0.932 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned & \textbf{0.947} & \textbf{0.826} & 0.813 & \textbf{0.862} \\
Racing-tuned + AOS & 0.895 & 0.820 & 0.843 & 0.853 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned & \textbf{10000} & \textbf{10000} & 50000 & 23333 \\
Racing-tuned + AOS & 20000 & 20000 & \textbf{20000} & \textbf{20000} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Variant} & \textbf{ZDT} & \textbf{DTLZ} & \textbf{WFG} & \textbf{Average} \\
\midrule
Baseline & \textbf{100.0} & 95.2 & 91.9 & 95.7 \\
Baseline + AOS & \textbf{100.0} & 97.6 & 88.1 & 95.3 \\
Racing-tuned & \textbf{100.0} & 98.1 & 88.9 & 95.7 \\
Racing-tuned + AOS & \textbf{100.0} & \textbf{100.0} & \textbf{95.9} & \textbf{98.6} \\
\bottomrule
\end{tabular}
\end{table}
