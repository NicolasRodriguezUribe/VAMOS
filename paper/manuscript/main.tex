...
\midrule
Numba & \textbf{0.89} & \textbf{0.90} & \textbf{0.94} & \textbf{0.91} \\
MooCore & 0.93 & 0.91 & 0.95 & 0.93 \\
NumPy & 2.08 & 2.07 & 2.03 & 2.06 \\
\bottomrule
\end{tabular}
\end{table}
...
We repeat the same runtime protocol for SMS-EMOA (steady-state, one offspring per iteration) and MOEA/D (decomposition with differential-evolution variation), reported in Tables~\ref{tab:frameworks_perf_smsemoa} and~\ref{tab:frameworks_perf_moead}.
...
\midrule
VAMOS & \textbf{0.89} & \textbf{0.90} & \textbf{0.94} & \textbf{0.91} \\
pymoo & 1.40 & 1.32 & 1.28 & 1.33 \\
DEAP & 5.60 & 5.79 & 11.54 & 7.64 \\
jMetalPy & 5.72 & 5.45 & 5.93 & 5.70 \\
Platypus & 10.86 & 11.31 & 16.38 & 12.85 \\
\bottomrule
\end{tabular}
\end{table}
...
zdt6 & 0.980 & \textbf{0.982} & <0.0001 & $\checkmark$ \\
dtlz1 & \textbf{0.915} & 0.911 & 1.000 &  \\
dtlz2 & 0.786 & \textbf{0.790} & 0.174 &  \\
dtlz3 & \textbf{0.708} & 0.689 & 1.000 &  \\
dtlz4 & \textbf{0.799} & 0.792 & 1.000 &  \\
dtlz5 & 0.964 & \textbf{0.964} & 1.000 &  \\
dtlz6 & 0.423 & \textbf{0.486} & 1.000 &  \\
dtlz7 & 0.883 & \textbf{0.888} & 1.000 &  \\
wfg1 & \textbf{0.439} & 0.437 & 1.000 &  \\
wfg2 & 0.982 & \textbf{0.983} & 1.000 &  \\
wfg3 & 0.974 & \textbf{0.974} & 1.000 &  \\
wfg4 & 0.960 & \textbf{0.961} & 1.000 &  \\
wfg5 & 0.826 & \textbf{0.827} & 0.276 &  \\
...
\midrule
pymoo & 14/21 & 16/21 & -0.04 \\
DEAP & 14/21 & 16/21 & -0.04 \\
jMetalPy & 15/21 & 16/21 & -0.00 \\
...
\midrule
dtlz1 & 0.92 & \textbf{0.88} & 2.09 \\
dtlz2 & \textbf{0.89} & 0.91 & 2.06 \\
dtlz3 & \textbf{0.85} & 0.85 & 2.04 \\
dtlz4 & \textbf{0.90} & 0.91 & 2.09 \\
dtlz5 & \textbf{0.89} & 0.91 & 2.06 \\
dtlz6 & \textbf{0.91} & 0.94 & 2.10 \\
dtlz7 & 0.91 & \textbf{0.91} & 2.05 \\
wfg1 & \textbf{0.91} & 0.92 & 2.02 \\
wfg2 & \textbf{0.94} & 0.95 & 2.07 \\
wfg3 & \textbf{0.94} & 0.96 & 2.03 \\
wfg4 & \textbf{0.91} & 0.93 & 2.00 \\
wfg5 & \textbf{0.91} & 0.92 & 2.00 \\
wfg6 & \textbf{1.12} & 1.13 & 2.20 \\
wfg7 & \textbf{0.93} & 0.95 & 2.01 \\
wfg8 & \textbf{1.06} & 1.07 & 2.16 \\
wfg9 & \textbf{1.40} & 1.42 & 2.49 \\
zdt1 & \textbf{0.90} & 1.00 & 2.12 \\
zdt2 & \textbf{0.92} & 0.94 & 2.05 \\
zdt3 & 0.94 & \textbf{0.94} & 2.07 \\
zdt4 & \textbf{0.81} & 0.86 & 2.17 \\
zdt6 & \textbf{0.84} & 0.85 & 2.07 \\
\midrule
\textbf{Average} & \textbf{0.94} & 0.96 & 2.09 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
dtlz1 & \textbf{0.92} & 1.32 & 6.01 & 5.43 & 9.44 \\
dtlz2 & \textbf{0.89} & 1.30 & 5.71 & 5.24 & 11.40 \\
dtlz3 & \textbf{0.85} & 1.32 & 6.41 & 5.50 & 10.24 \\
dtlz4 & \textbf{0.90} & 1.32 & 5.81 & 5.33 & 11.52 \\
dtlz5 & \textbf{0.89} & 1.31 & 5.80 & 5.41 & 12.27 \\
dtlz6 & \textbf{0.91} & 1.38 & 5.70 & 5.34 & 10.93 \\
dtlz7 & \textbf{0.91} & 1.28 & 5.47 & 5.57 & 11.68 \\
wfg1 & \textbf{0.91} & 1.26 & 7.49 & 6.08 & 12.14 \\
wfg2 & \textbf{0.94} & 1.28 & 11.82 & 5.92 & 16.38 \\
wfg3 & \textbf{0.94} & 1.28 & 11.54 & 5.87 & 16.82 \\
wfg4 & \textbf{0.91} & 1.24 & 6.85 & 5.82 & 12.18 \\
wfg5 & \textbf{0.91} & 1.24 & 6.90 & 5.84 & 12.45 \\
wfg6 & \textbf{1.12} & 1.44 & 32.74 & 6.72 & 37.65 \\
wfg7 & \textbf{0.93} & 1.26 & 9.30 & 5.91 & 14.67 \\
wfg8 & \textbf{1.06} & 1.37 & 19.74 & 6.75 & 24.35 \\
wfg9 & \textbf{1.40} & 1.75 & 57.27 & 8.25 & 63.06 \\
zdt1 & \textbf{0.90} & 1.35 & 5.72 & 6.05 & 11.31 \\
zdt2 & \textbf{0.92} & 1.38 & 5.57 & 5.89 & 11.05 \\
zdt3 & \textbf{0.94} & 1.39 & 5.81 & 5.79 & 11.40 \\
zdt4 & \textbf{0.81} & 1.36 & 5.66 & 5.27 & 8.99 \\
zdt6 & \textbf{0.84} & 1.49 & 5.31 & 5.23 & 9.57 \\
\midrule
\textbf{Average} & \textbf{0.94} & 1.35 & 11.08 & 5.87 & 16.17 \\
\bottomrule
\end{tabular}
\end{table*}
...
\midrule
dtlz1 & $[-0.76,+0.92]$ & $[-0.63,+0.05]$ & $[-0.72,+0.23]$ & $[-0.13,+0.85]$ \\
dtlz2 & $[-1.20,-0.46]$ & $[-1.31,-0.51]$ & $[-1.16,+0.30]$ & $[-0.94,+0.38]$ \\
dtlz3 & $[-0.18,+20.82]$ & $[-7.37,+11.08]$ & $[-11.13,+9.93]$ & $[+6.53,+40.20]$ \\
dtlz4 & $[-0.35,+1.10]$ & $[-0.77,+0.03]$ & $[-0.91,+0.78]$ & $[-1.02,+84.30]$ \\
dtlz5 & $[-0.14,+0.07]$ & $[-0.07,+0.11]$ & $[-0.15,+0.11]$ & $[-0.19,+0.02]$ \\
dtlz6 & $[-23.30,+4.37]$ & $[-19.46,+12.55]$ & $[-6.34,+19.49]$ & $[-32.31,-15.09]$ \\
dtlz7 & $[-1.08,+0.21]$ & $[-0.67,-0.22]$ & $[-0.82,+0.57]$ & $[-1.02,+21.20]$ \\
wfg1 & $[-11.94,+1.39]$ & $[-9.53,+4.13]$ & $[-6.14,+10.83]$ & $[+45.57,+69.49]$ \\
...
zdt4 & $[-0.06,+0.02]$ & $[-0.09,+0.10]$ & $[-0.05,+0.08]$ & $[-0.02,+0.05]$ \\
zdt6 & $[-0.27,-0.23]$ & $[+0.09,+0.18]$ & $[+0.01,+0.17]$ & $[-0.41,-0.37]$ \\
\bottomrule
\end{tabular}
\end{table*}
