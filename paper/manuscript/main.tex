...
\midrule
Numba & \textbf{0.87} & \textbf{0.90} & \textbf{0.97} & \textbf{0.92} \\
MooCore & 0.91 & 0.91 & 0.99 & 0.94 \\
NumPy & 2.04 & 2.07 & 2.12 & 2.08 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
VAMOS & \textbf{0.87} & \textbf{0.90} & \textbf{0.97} & \textbf{0.92} \\
pymoo & 1.33 & 1.32 & 1.30 & 1.31 \\
DEAP & 5.44 & 5.78 & 11.61 & 7.61 \\
jMetalPy & 5.72 & 5.40 & 6.19 & 5.77 \\
Platypus & 10.73 & 11.20 & 16.66 & 12.86 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
dtlz1 & 0.88 & \textbf{0.87} & 2.07 \\
dtlz2 & \textbf{0.90} & 0.93 & 2.08 \\
dtlz3 & \textbf{0.84} & 0.85 & 2.07 \\
dtlz4 & \textbf{0.90} & 0.92 & 2.06 \\
dtlz5 & \textbf{0.88} & 0.89 & 2.04 \\
dtlz6 & 0.91 & \textbf{0.90} & 2.13 \\
dtlz7 & 0.93 & \textbf{0.91} & 2.10 \\
wfg1 & \textbf{0.92} & 0.97 & 2.08 \\
wfg2 & 0.95 & \textbf{0.95} & 2.11 \\
wfg3 & \textbf{0.95} & 0.97 & 2.04 \\
wfg4 & \textbf{0.93} & 0.97 & 2.04 \\
wfg5 & \textbf{0.91} & 0.93 & 2.00 \\
wfg6 & \textbf{1.12} & 1.13 & 2.21 \\
wfg7 & \textbf{0.93} & 0.95 & 2.01 \\
wfg8 & \textbf{1.06} & 1.07 & 2.17 \\
wfg9 & \textbf{1.40} & 1.42 & 2.49 \\
zdt1 & \textbf{0.97} & 1.00 & 2.08 \\
zdt2 & \textbf{0.86} & 0.93 & 2.05 \\
zdt3 & \textbf{0.88} & 0.91 & 2.03 \\
zdt4 & \textbf{0.81} & 0.83 & 2.02 \\
zdt6 & \textbf{0.81} & 0.85 & 2.04 \\
\midrule
...
\midrule
dtlz1 & \textbf{0.88} & 1.29 & 5.95 & 5.41 & 9.43 \\
dtlz2 & \textbf{0.90} & 1.30 & 5.61 & 5.23 & 11.34 \\
dtlz3 & \textbf{0.84} & 1.32 & 6.31 & 5.62 & 10.26 \\
dtlz4 & \textbf{0.90} & 1.32 & 5.75 & 5.25 & 11.32 \\
dtlz5 & \textbf{0.88} & 1.26 & 5.76 & 5.40 & 12.23 \\
dtlz6 & \textbf{0.91} & 1.37 & 5.63 & 5.31 & 10.75 \\
dtlz7 & \textbf{0.93} & 1.31 & 5.52 & 5.70 & 11.79 \\
wfg1 & \textbf{0.92} & 1.28 & 7.53 & 6.20 & 12.36 \\
wfg2 & \textbf{0.95} & 1.28 & 12.04 & 6.10 & 16.66 \\
wfg3 & \textbf{0.95} & 1.28 & 11.61 & 5.98 & 17.09 \\
wfg4 & \textbf{0.93} & 1.25 & 6.97 & 5.93 & 12.47 \\
wfg5 & \textbf{0.91} & 1.26 & 7.02 & 6.10 & 12.72 \\
wfg6 & \textbf{1.12} & 1.45 & 32.81 & 6.76 & 37.83 \\
wfg7 & \textbf{0.93} & 1.27 & 9.29 & 5.90 & 14.74 \\
wfg8 & \textbf{1.06} & 1.38 & 19.78 & 6.77 & 24.41 \\
wfg9 & \textbf{1.40} & 1.75 & 57.37 & 8.29 & 63.03 \\
zdt1 & \textbf{0.97} & 1.32 & 5.55 & 5.98 & 11.36 \\
zdt2 & \textbf{0.86} & 1.32 & 5.46 & 5.91 & 11.01 \\
zdt3 & \textbf{0.88} & 1.29 & 5.48 & 5.72 & 10.99 \\
zdt4 & \textbf{0.81} & 1.27 & 5.47 & 5.24 & 8.53 \\
zdt6 & \textbf{0.81} & 1.50 & 5.07 & 5.03 & 9.25 \\
\midrule
\textbf{Average} & \textbf{0.94} & 1.34 & 11.05 & 5.90 & 16.17 \\
\bottomrule
\end{tabular}
\end{table*}
