...
\midrule
Baseline & \textbf{0.88} & \textbf{0.94} & \textbf{0.98} & \textbf{0.93} \\
Baseline + AOS & 0.89 & 1.72 & 1.00 & 1.20 \\
Racing-tuned & 11.03 & 11.28 & 5.62 & 9.31 \\
Racing-tuned + AOS & 6.55 & 11.68 & 4.77 & 7.67 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned + AOS & 0.991 & 0.839 & 0.937 & 0.922 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned & \textbf{0.985} & \textbf{0.804} & \textbf{0.895} & \textbf{0.895} \\
Racing-tuned + AOS & 0.808 & 0.732 & 0.881 & 0.807 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned & \textbf{0.989} & \textbf{0.832} & \textbf{0.926} & \textbf{0.916} \\
Racing-tuned + AOS & 0.974 & 0.825 & 0.908 & 0.902 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned & \textbf{0.913} & \textbf{0.778} & \textbf{0.874} & \textbf{0.855} \\
Racing-tuned + AOS & 0.810 & 0.752 & 0.861 & 0.808 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned + AOS & 20000 & 20000 & \textbf{20000} & 20000 \\
\bottomrule
\end{tabular}
\end{table}
...
Racing-tuned + AOS & \textbf{100.0} & 85.2 & \textbf{91.5} & 92.2 \\
\bottomrule
\end{tabular}
\end{table}
