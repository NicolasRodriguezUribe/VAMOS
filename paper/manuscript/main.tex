...
The remainder of the paper reviews related work, presents the \VAMOS{} framework, and reports a cross-framework empirical comparison.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.98\textwidth]{figures/representation_population.png}
