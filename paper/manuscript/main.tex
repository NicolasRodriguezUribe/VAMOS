...
\textcolor{red}{Tables~\ref{tab:frameworks_hv_nsgaii_ss} and~\ref{tab:frameworks_hv_nsgaii_archive} extend this analysis to the NSGA-II steady-state and external-archive variants. For the steady-state variant, all three frameworks achieve nearly identical overall HV (0.949 for \VAMOS{} and pymoo, 0.948 for jMetalPy). For the archive variant, pymoo and jMetalPy reach near-perfect normalized HV (1.000 overall), while \VAMOS{} attains 0.944---a gap attributable to differences in how the unbounded archive interacts with the survival operator across frameworks.}
