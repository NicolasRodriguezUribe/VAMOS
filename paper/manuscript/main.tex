...
\begin{table}[htbp]
\centering
\caption{Median runtime (seconds) aggregated by problem family across all frameworks}
...
\midrule
VAMOS & \textbf{0.88} & \textbf{0.91} & \textbf{4.19} & \textbf{1.99} \\
pymoo & 1.36 & 1.35 & 10.02 & 4.25 \\
jMetalPy & 5.63 & 5.49 & 33.85 & 14.99 \\
\bottomrule
\end{tabular}
\end{table}
...
Tables~\ref{tab:frameworks_hv_nsgaii_ss} and~\ref{tab:frameworks_hv_nsgaii_archive} extend this analysis to the NSGA-II steady-state and external-archive variants. For the steady-state variant, all three frameworks achieve nearly identical overall HV. For the archive variant, all three frameworks reach comparable normalized HV across ZDT and DTLZ families (1.000), confirming that the unbounded archive accumulates equivalent approximation sets regardless of the framework.
...
\midrule
dtlz1 & \textbf{0.89} & 0.91 & 2.17 \\
dtlz2 & 0.92 & \textbf{0.91} & 2.08 \\
dtlz3 & \textbf{0.84} & 0.86 & 2.10 \\
dtlz4 & \textbf{0.91} & 0.94 & 2.11 \\
dtlz5 & \textbf{0.89} & 0.90 & 2.12 \\
dtlz6 & \textbf{0.92} & 0.93 & 2.11 \\
dtlz7 & 0.94 & \textbf{0.93} & 2.12 \\
wfg1 & \textbf{3.17} & 6.71 & 10.11 \\
wfg2 & \textbf{3.70} & 5.81 & 9.03 \\
wfg3 & \textbf{4.93} & 5.89 & 10.56 \\
wfg4 & \textbf{4.21} & 5.77 & 10.65 \\
wfg5 & \textbf{4.25} & 9.66 & 13.07 \\
wfg6 & \textbf{5.31} & 6.74 & 11.16 \\
wfg7 & \textbf{4.07} & 6.08 & 10.41 \\
wfg8 & \textbf{4.22} & 11.36 & 11.36 \\
wfg9 & \textbf{4.32} & 10.13 & 11.50 \\
zdt1 & \textbf{0.91} & 0.97 & 2.12 \\
zdt2 & \textbf{0.88} & 0.92 & 2.15 \\
zdt3 & \textbf{0.89} & 0.93 & 2.11 \\
zdt4 & 0.83 & \textbf{0.83} & 2.11 \\
zdt6 & \textbf{0.82} & 0.84 & 2.03 \\
\midrule
\textbf{Average} & \textbf{2.32} & 3.76 & 5.87 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lccc}
\toprule
\textbf{Problem} & \textbf{VAMOS} & \textbf{pymoo} & \textbf{jMetalPy} \\
\midrule
dtlz1 & \textbf{0.89} & 1.35 & 5.48 \\
dtlz2 & \textbf{0.92} & 1.32 & 5.28 \\
dtlz3 & \textbf{0.84} & 1.34 & 5.64 \\
dtlz4 & \textbf{0.91} & 1.31 & 5.30 \\
dtlz5 & \textbf{0.89} & 1.34 & 5.55 \\
dtlz6 & \textbf{0.92} & 1.40 & 5.41 \\
dtlz7 & \textbf{0.94} & 1.31 & 5.73 \\
wfg1 & \textbf{3.17} & 7.55 & 15.22 \\
wfg2 & \textbf{3.70} & 9.88 & 35.48 \\
wfg3 & \textbf{4.93} & 12.15 & 35.59 \\
wfg4 & \textbf{4.21} & 10.12 & 17.18 \\
wfg5 & \textbf{4.25} & 10.00 & 16.01 \\
wfg6 & \textbf{5.31} & 11.11 & 100.01 \\
wfg7 & \textbf{4.07} & 11.48 & 26.39 \\
wfg8 & \textbf{4.22} & 9.32 & 61.65 \\
wfg9 & \textbf{4.32} & 9.48 & 163.89 \\
zdt1 & \textbf{0.91} & 1.37 & 5.79 \\
zdt2 & \textbf{0.88} & 1.37 & 5.80 \\
zdt3 & \textbf{0.89} & 1.32 & 5.79 \\
zdt4 & \textbf{0.83} & 1.31 & 5.24 \\
zdt6 & \textbf{0.82} & 1.48 & 5.09 \\
\midrule
\textbf{Average} & \textbf{2.32} & 5.11 & 25.60 \\
\bottomrule
\end{tabular}
\end{table*}
