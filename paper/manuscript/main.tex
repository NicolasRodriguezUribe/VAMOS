...
\midrule
\texttt{pop\_size} & 180 \\
\texttt{offspring\_size} & 180 \\
Crossover & \texttt{sbx(eta=6.816, prob=0.9861)} \\
Mutation & \texttt{non\_uniform(prob=0.1, prob\_factor=1.034)} \\
Selection & \texttt{tournament(pressure=4)} \\
External archive & \texttt{unbounded (size=180)} \\
\bottomrule
\end{tabular}
\end{table}
