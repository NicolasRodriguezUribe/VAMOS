...
\midrule
NSGA-II & \cite{deb2002fast} & Dominance & R, P, B, I, M & 25 & 24 & Offspring ratio, repair, external archive (capacity, pruning, unbounded) & 36 \\
...
\multirow{8}{*}{General} & Pop.\ Size $\in \Intdomain{20, 200}$ (log-scale); default $\mathbf{100}$ & -- \\
 ...
 & \textit{Archive Capacity} $\in \Intdomain{20, 2000}$ (log-scale) & \textit{Archive} = True, \textit{Unbounded} = False \\
 & \textit{Archive Prune Policy} $\in$ \{crowding, hv\_contrib, mc\_hv\_contrib, spea2, random\} & \textit{Archive} = True, \textit{Unbounded} = False \\ \midrule
