...
\midrule
VAMOS & \textbf{0.990 (0.008)} & \textbf{0.799 (0.153)} & \textbf{0.934 (0.140)} & \textbf{0.934 (0.181)} \\
...
\midrule
dtlz1 & \textbf{2.67} & 3.21 & 11.39 \\
dtlz2 & \textbf{3.01} & 3.38 & 12.23 \\
dtlz3 & \textbf{3.60} & 4.44 & 16.82 \\
dtlz4 & \textbf{3.72} & 3.84 & 15.15 \\
dtlz5 & \textbf{3.74} & 4.03 & 14.65 \\
dtlz6 & \textbf{3.90} & 4.52 & 15.28 \\
dtlz7 & \textbf{3.90} & 4.22 & 16.41 \\
wfg1 & \textbf{4.17} & 4.76 & 30.35 \\
wfg2 & \textbf{3.90} & 4.55 & 48.26 \\
wfg3 & \textbf{3.81} & 4.18 & 44.80 \\
wfg4 & \textbf{3.93} & 4.42 & 24.93 \\
wfg5 & \textbf{4.31} & 4.61 & 25.57 \\
wfg6 & \textbf{4.40} & 4.91 & 122.00 \\
wfg7 & \textbf{3.85} & 4.31 & 37.01 \\
wfg8 & \textbf{4.18} & 4.68 & 86.14 \\
wfg9 & \textbf{3.85} & 4.75 & 179.86 \\
zdt1 & \textbf{2.63} & 2.93 & 11.54 \\
zdt2 & \textbf{2.79} & 3.28 & 12.01 \\
zdt3 & \textbf{2.76} & 3.08 & 11.81 \\
zdt4 & \textbf{2.41} & 3.12 & 11.23 \\
zdt6 & \textbf{2.44} & 3.51 & 10.39 \\
\midrule
\textbf{Average} & \textbf{3.52} & 4.03 & 36.09 \\
\bottomrule
\end{tabular}
\end{table*}
