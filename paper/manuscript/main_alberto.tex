...
\midrule
Dominance     & NSGA-II  &  \cite{deb2002fast} \\
Dominance     & NSGA-III &  \cite{deb2014evolutionary} \\
Dominance     & SPEA2    &  \cite{zitzler2001spea2} \\
Dominance     & AGE-MOEA &  \cite{panichella2019adaptive} \\
Decomposition & MOEA/D   &  \cite{zhang2007moea} \\
Decomposition & RVEA     &  \cite{cheng2016reference} \\
Indicator     & SMS-EMOA &  \cite{beume2007sms} \\
Indicator     & IBEA     &  \cite{zitzler2004indicator} \\
Swarm         & SMPSO    & \cite{nebro2009smpso} \\
\bottomrule
\end{tabular}
\end{table}
