"""Run the full 2-objective ZCAT GCES ablation campaign."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the full 2-objective ZCAT GCES ablation campaign.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_config = {
        ...
        "campaign": "gces_ablation_zcat_2obj_full",
    }

    print("GCES full ZCAT 2-objective ablation")
    ...
    for problem in args.problems:
        ...
        for algorithm in args.algorithms:
            for seed in seeds:
                ...
                print(
                    f"  {ALGORITHM_LABELS[algorithm]:>11} seed={seed:>2} | "
    ...
    print(f"\nWrote ablation outputs to {output_dir}")
    return 0
