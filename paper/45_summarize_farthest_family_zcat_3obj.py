"""Regenerate summaries and the Markdown report for the farthest-family 3D campaign."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Regenerate summary CSVs and Markdown report for the farthest-family 3-objective ZCAT campaign."
    )
