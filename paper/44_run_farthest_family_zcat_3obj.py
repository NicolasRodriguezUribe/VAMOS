"""Run the staged farthest-family 3-objective ZCAT campaign."""
...
DEFAULT_COMPARISONS = [
    ...
    ("nsga2_sector_farthest", "nsgaii"),
    ("nsga2_sector_farthest", "nsga2_farthest"),
    ("nsga2_sector_farthest", "gces_nogeo"),
    ("nsga2_sector_farthest", "gces"),
    ("nsga2_sector_farthest", "nsga2_hvref_farthest"),
]
DEFAULT_N_OBJ = 3
DEFAULT_OUTPUT_DIR = Path(__file__).parent.parent / "experiments" / "farthest_family_zcat_3obj_full"


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the staged farthest-family 3-objective ZCAT campaign.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_config = {
        ...
        "campaign": "farthest_family_zcat_3obj_full",
        "report_title": "Farthest-family 3-objective ZCAT survival-only campaign",
        "report_note": (
            ...
            "selection differs across the farthest-derived selectors, nsga2_sector_farthest, and the GCES-family variants."
        ),
    }

    print("Farthest-family full ZCAT 3-objective campaign")
