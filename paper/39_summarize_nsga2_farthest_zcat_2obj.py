"""Regenerate summaries and the Markdown report for the nsga2_farthest campaign."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Regenerate summary CSVs and Markdown report for the nsga2_farthest 2-objective ZCAT campaign."
    )
