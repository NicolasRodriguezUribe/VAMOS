"""
MOEA/D racing tuner (wrapper).

This thin wrapper forwards to the generic racing tuner with MOEA/D defaults.

Usage:
    python examples/tuning/racing_tuner_moead.py
"""
...
def main() -> None:
    argv = sys.argv[1:]
    argv = _inject_default(argv, "--algorithm", "moead")
