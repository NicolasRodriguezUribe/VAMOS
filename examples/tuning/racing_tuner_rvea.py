"""
RVEA racing tuner (wrapper).

This thin wrapper forwards to the generic racing tuner with RVEA defaults.

Usage:
    python examples/tuning/racing_tuner_rvea.py
"""
...
def main() -> None:
    argv = sys.argv[1:]
    argv = _inject_default(argv, "--algorithm", "rvea")
